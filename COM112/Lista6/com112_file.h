...
//Registrar os resultados obtidos em Merge Sort no arquivo com112_relatorio.txt
void fileMerge(double tempo, int n_compara, int n_movimento);

//Registrar os resultados obtidos em Quick Sort no arquivo com 112_relatorio.txt
