...
//Função para registrar o resultado do Insertion Sort em com112_relatorio.txt
...
//Função para registrar o resultado do Merge Sort em com112.relatorio.txt
void fileMerge(double tempo, int n_compara, int n_movimento){
    FILE *file;
    file = fopen("com112_relatorio.txt", "a");

    fprintf(file, "Metodo Merge Sort\n");
    fprintf(file, "   Tempo de execucao: %lf\n", tempo);
    fprintf(file, "   Numero de comparacoes: %d\n", n_compara);
    fprintf(file, "   Numero de movimentacoes: %d\n", n_movimento);
...
//Função para registrar o resultado do Quick Sort em com112.relatorio.txt
void fileQuick(double tempo, int n_compara, int n_movimento){
    FILE *file;
    file = fopen("com112_relatorio.txt", "a");

    fprintf(file, "Metodo Quick Sort\n");
    fprintf(file, "   Tempo de execucao: %lf\n", tempo);
    fprintf(file, "   Numero de comparacoes: %d\n", n_compara);
    fprintf(file, "   Numero de movimentacoes: %d\n", n_movimento);
